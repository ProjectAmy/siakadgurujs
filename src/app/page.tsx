...
export default function Home() {
  return (
    <div className="min-h-screen flex flex-col justify-center items-center bg-white md:bg-blue-200">
      <div className="w-full max-w-6xl bg-white rounded-lg shadow-lg flex flex-col md:flex-row items-center justify-center gap-2 md:gap-0 p-4 md:p-12 min-h-screen md:min-h-0 pt-24 pb-24 md:pt-24 md:pb-24">
        {/* Logo Section */}
